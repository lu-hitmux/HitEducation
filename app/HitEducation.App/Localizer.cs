...
public static class Localizer
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["ConfirmDeleteRoster"] = "Delete imported roster \"{0}\"? The app's copied file and thumbnails will be removed. The original source file will not be changed.",
        ["DropRosterToImport"] = "Release to import: {0}",
        ["ImportingRoster"] = "Importing roster: {0}...",
        ["RosterImportSucceeded"] = "Imported {0}: {1} members.",
    ...
    private static string Zh(string key) => key switch
    {
			...
			"CurrentRoster" => "当前名单", 
			"DeleteRoster" => "删除名单", 
			"ConfirmDeleteRoster" => "确认删除已导入名单“{0}”？程序内部保存的副本和缩略图会被删除，原始导入文件不会被修改。", 
			"DropRosterToImport" => "释放鼠标导入：{0}", 
			"ImportingRoster" => "正在导入名单：{0}...", 
			"RosterImportSucceeded" => "已导入 {0}：{1} 个成员。", 
			"ResetWeights" => "一键重置", 
